...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285609585220@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["623198744856@s.whatsapp.net"] // GANTI NOMOR LU
			const frendsowner = ["6285609585220@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6285609585220@s.whatsapp.net', options, text, {quoted: mek})
               ...
               case 'infogempa':
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 TAMA BOT 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
				...
				case `addadmin`:
                   ...
                   reply('Success Menambahkan Admin Tamzzz!')
				   }
                   break
				case 'wait':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
